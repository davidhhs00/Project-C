...
export default class NgtiMap extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (this.props.amountOfUsers != nextProps.amountOfUsers) {
            this.setState({ amountOfUsers: nextProps.amountOfUsers });
            this.setStateAndWorkplace(0);
        }
    }
        ...
        return(
            <div className="ngti-map">
                <div className="mapImg">
                    <div 
                        onClick={() => this.state.reserved[0].reservedSeats + this.state.amountOfUsers >= this.state.reserved[0].amountOfSeats ? null :  this.state.selected === 1 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(1)} 
                        alt="1" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[1].reservedSeats + this.state.amountOfUsers >= this.state.reserved[1].amountOfSeats ? null : this.state.selected === 2 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(2)} 
                        alt="2" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[2].reservedSeats + this.state.amountOfUsers >= this.state.reserved[2].amountOfSeats ? null : this.state.selected === 3 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(3)} 
                        alt="3" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[3].reservedSeats + this.state.amountOfUsers >= this.state.reserved[3].amountOfSeats ? null : this.state.selected === 4 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(4)} 
                        alt="4" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[4].reservedSeats + this.state.amountOfUsers >= this.state.reserved[4].amountOfSeats ? null : this.state.selected === 5 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(5)}
                        alt="5" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[5].reservedSeats + this.state.amountOfUsers >= this.state.reserved[5].amountOfSeats ? null : this.state.selected === 6 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(6)} 
                        alt="6" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[6].reservedSeats + this.state.amountOfUsers >= this.state.reserved[6].amountOfSeats ? null : this.state.selected === 7 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(7)} 
                        alt="7" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[7].reservedSeats + this.state.amountOfUsers >= this.state.reserved[7].amountOfSeats ? null : this.state.selected === 8 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(8)} 
                        alt="8" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[8].reservedSeats + this.state.amountOfUsers >= this.state.reserved[8].amountOfSeats ? null : this.state.selected === 9 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(9)} 
                        alt="9" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[9].reservedSeats + this.state.amountOfUsers >= this.state.reserved[9].amountOfSeats ? null : this.state.selected === 10 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(10)}
                        alt="10" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[10].reservedSeats + this.state.amountOfUsers >= this.state.reserved[10].amountOfSeats ? null : this.state.selected === 11 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(11)}
                        alt="11" 
                    ...
                    <div 
                        onClick={() => this.state.reserved[11].reservedSeats + this.state.amountOfUsers >= this.state.reserved[11].amountOfSeats ? null : this.state.selected === 12 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(12)} 
                        alt="12"
                    ...
                    <div 
                        onClick={() => this.state.reserved[12].reservedSeats + this.state.amountOfUsers >= this.state.reserved[12].amountOfSeats ? null : this.state.selected === 13 ? this.setStateAndWorkplace(0) : this.setStateAndWorkplace(13)} 
                        alt="13" 
